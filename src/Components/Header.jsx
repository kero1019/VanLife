...
export default function Header() {
  return (
    <header className="bg-main-background flex justify-between p-5 items-center h-[15%]">
      ...
      <nav className="flex  gap-5 text-gray-text font-semibold items-center">
        ...
        <NavLink to="/VanLife/login" className={({isActive})=>isActive? "text-red-500 font-bold underline text-[1.5rem]":"hover:font-semibold text-[1.2rem] hover:text-red-500 hover:underline"}><CgProfile /></NavLink>
      </nav>
    </header>
  );
}
